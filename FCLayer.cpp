...
xt::xarray<double> FCLayer::backward(xt::xarray<double> DY) {
    ...
    //     auto dy_vector = xt::view(DY,i,xt::all());
    //     auto x_vector = xt::view(m_aCached_X,i,xt::all());
    //     xt::view(dW_batch, i, xt::all(), xt::all()) = xt::linalg::outer(dy_vector, xt::transpose(x_vector));
    // }
